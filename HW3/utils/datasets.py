...
class LoadVideo:  # for inference
    def __init__(self, path, img_size=(1088, 608)):
        ...
        self.w, self.h = self.get_size(self.vw, self.vh, self.width, self.height) ## w, h:(568, 320)
    ...
    def __next__(self):
        ...
        img0 = cv2.resize(img0, (self.w, self.h)) ## (320, 568, 3) (H,W,C)

        # Padded resize
        img, _, _, _ = letterbox(img0, height=self.height, width=self.width) ## (320, 576, 3)
